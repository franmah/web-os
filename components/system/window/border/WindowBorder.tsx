...
const WindowBorder: FC<{
	...
	return (
		<StyledWindowBorder resizing={isResizing} zIndex={zIndex}>
			{/*  TOP BORDER */}
			<div className={allowResize ? 'topBorder' : ''}>
				<div
					className={'topLeft'}
			...
			<div className={allowResize ? 'centerLeft' : ''}>
				<div
					className={'leftCenterTop'}
					onMouseDown={event => onBordersMouseDown(event, WindowResizeDirection.TopLeft)}
				></div>
				<div
					className={'leftCenterMiddle'}
					onMouseDown={event => onBordersMouseDown(event, WindowResizeDirection.Left)}
				></div>
				<div
					className={'leftCenterBottom'}
			...
			<div className={allowResize ? 'centerRight' : ''}>
				<div
					className={'rightCenterTop'}
					onMouseDown={event => onBordersMouseDown(event, WindowResizeDirection.TopRight)}
				></div>
				<div
					className={'rightCenterMiddle'}
					onMouseDown={event => onBordersMouseDown(event, WindowResizeDirection.Right)}
				></div>
				<div
					className={'rightCenterBottom'}
					onMouseDown={event => onBordersMouseDown(event, WindowResizeDirection.BottomRight)}
				></div>
			</div>

			{/*  BOTTOM BORDER */}
			<div className={allowResize ? 'bottomBorder' : ''}>
				<div
					className={'bottomLeft'}
					onMouseDown={event => onBordersMouseDown(event, WindowResizeDirection.BottomLeft)}
				></div>
				<div className={'bottom'} onMouseDown={event => onBordersMouseDown(event, WindowResizeDirection.Bottom)}></div>
				<div
